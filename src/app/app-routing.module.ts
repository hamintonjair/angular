...
const routes: Routes = [
  ...
  { path : 'persona-permisos', component: ModulosComponent },
  ...
  { path : 'agregar-permisos', component: FormularioModulosComponent },
  { path : 'editar-permisos/:id', component: FormularioModulosComponent },
  ...
  { path : 'editar-revision/:id', component: AgregarRevisionComponent},
